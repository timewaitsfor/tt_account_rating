...
tt_ywdata_engine = create_engine('mysql+pymysql://root:ZAQ12wssd@10.96.130.69:3306/tt_ywdata?charset=utf8', echo=False)
...
# class tt_ywdata_content1201(TT_YWData_Base, BaseMixin):
#     __tablename__ = "content_1201"
#     id = Column(BIGINT, primary_key=True)
#     author = Column(String(255), nullable=False)
#     author_id = Column(BIGINT)
#     tt_text = Column(String(4096))
...
class tt_ywdata_content1220(TT_YWData_Base, BaseMixin):
    __tablename__ = "content_1220"
    id = Column(BIGINT, primary_key=True)
    author = Column(String(255), nullable=False)
    author_id = Column(BIGINT)
    tt_text = Column(String(4096))
...
class tt_ywdata_author_analysed1220(TT_YWData_Base):
    __tablename__ = "author_analysed_1220"
    author = Column(String(255), primary_key=True, nullable=False)
    author_id = Column(BIGINT)
    tt_number = Column(Integer)
    tt_zh_number = Column(Integer)
...
# class tt_ywdata_author_analysed1201(TT_YWData_Base):
#     __tablename__ = "author_analysed1201"
#     author = Column(String(255), primary_key=True, nullable=False)
#     author_id = Column(BIGINT)
#     tt_number = Column(Integer)
#     tt_zh_number = Column(Integer)
...
# class tt_ywdata_content1208(TT_YWData_Base, BaseMixin):
#     __tablename__ = "content_1208"
#     id = Column(BIGINT, primary_key=True)
#     author = Column(String(255), nullable=False)
#     author_id = Column(BIGINT)
#     tt_text = Column(String(4096))
...
# class tt_ywdata_author_analysed1208(TT_YWData_Base):
#     __tablename__ = "author_analysed_1208"
#     author = Column(String(255), primary_key=True, nullable=False)
#     author_id = Column(BIGINT)
#     tt_number = Column(Integer)
#     tt_zh_number = Column(Integer)
